	...
	for (let i=0;i<inputArr.length;i++) {
		...
		for (let k=0;k<inputArr.length;k++) {
			if (k === i) {
				...
				// console.log(`${inputArr[i]} + ${inputArr[k]} = ${firstNum + secondNum}`);
